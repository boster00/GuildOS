  ...
  toc: {
    initAgent: {
      ...
      howTo: [
        ...
        "If NEXT_PUBLIC_SUPABASE_URL and SUPABASE_SECRETE_KEY are in your shell environment (check with: echo $SUPABASE_SECRETE_KEY), write them to ~/guildos/.env.local:",
        "echo NEXT_PUBLIC_SUPABASE_URL=$NEXT_PUBLIC_SUPABASE_URL > ~/guildos/.env.local",
        "echo SUPABASE_SECRETE_KEY=$SUPABASE_SECRETE_KEY >> ~/guildos/.env.local",
        "If not in your environment either: escalate to user.",
        "",
