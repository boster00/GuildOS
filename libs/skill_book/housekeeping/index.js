  ...
  toc: {
    initAgent: {
      ...
      howTo: [
        ...
        "",
        "**Step 3: Read instructions and load your skill books**",
        "1. Read ~/guildos/CLAUDE.md.",
...
`,
    ...
    submitForPurrview: {
      ...
      howTo: [
        ...
        "",
        "**REPLACE, do not pile on.** If resubmitting after feedback: for each deliverable item that changed,",
        "delete the old storage file and upload a new one. Update the inventory entry in place — same key, new URL.",
        "Do NOT add new items alongside old ones. One item per deliverable at all times.",
        "Cat reviewing a pile of mostly-similar screenshots will reject immediately.",
        "",
